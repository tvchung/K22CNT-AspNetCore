...
public partial class BookStoreDfContext : DbContext
{
    public BookStoreDfContext()
    {
    }

    public BookStoreDfContext(DbContextOptions<BookStoreDfContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Server=.\\SQL2019; Database=BookStoreDF; Trusted_Connection=True; MultipleActiveResultSets=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A61534BF52");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C2074627DDBE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BECDDB9B2");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCF3739471A");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36CAD0702D5");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FAB33ECBF83");
